...
def decrypt(ciphertext: str, keyword: str) -> dict:
    ...
    for i in range(0, len(ciphertext), 2):
        ...
        if first_letter[0] == second_letter[0]:
            message += encryption_matrix[first_letter[0]][(first_letter[1] - 1) % 5]
            message += encryption_matrix[second_letter[0]][(second_letter[1] - 1) % 5]
        elif first_letter[1] == second_letter[1]:
            message += encryption_matrix[(first_letter[0] - 1) % 6][first_letter[1]]
            message += encryption_matrix[(second_letter[0] - 1) % 6][second_letter[1]]
        else:
            message += encryption_matrix[first_letter[0]][second_letter[1]]
            message += encryption_matrix[second_letter[0]][first_letter[1]]
